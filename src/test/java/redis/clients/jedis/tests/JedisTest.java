...
public class JedisTest extends JedisCommandTestBase {
	...
	public void connectWithShardInfo() {
		JedisShardInfo shardInfo = new JedisShardInfo("192.168.81.128", Protocol.DEFAULT_PORT);
	...
	public void timeoutConnectionWithURI() throws Exception {
		jedis = new Jedis(new URI("redis://:123456@192.168.81.128:6379/2"), 15000);
